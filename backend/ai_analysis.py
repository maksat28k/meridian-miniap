...
- Клинические руководства: AHA/ACC, ESC, ADA, WHO, Endocrine Society, AACE, NICE (UK)
- Рецензируемые журналы: NEJM, JAMA, Lancet, BMJ, Annals of Internal Medicine, JCEM
- Базы данных: PubMed/MEDLINE, Cochrane Library, UpToDate
- Российские стандарты: клинические рекомендации МЗ РФ
...
Каждую рекомендацию, каждый риск, каждый паттерн ОБЯЗАТЕЛЬНО подкрепляй конкретным источником в формате:
  "evidence": "Автор и соавт., Журнал, Год — краткая суть"

Примеры правильного цитирования:
- "Holick MF et al., NEJM 2007 — дефицит витамина D связан с повышенным риском переломов и иммунодисфункции"
- "Ridker PM et al., NEJM 2017 (JUPITER trial) — высокий СРБ предиктор ССЗ независимо от уровня ЛПНП"
...
- "Cochrane Review, Bjelakovic et al. 2014 — омега-3 и снижение триглицеридов"
- "ESC Guidelines on Dyslipidaemia 2019 — целевой ЛПНП <1.8 ммоль/л при высоком ССР"
- "WHO Iron Deficiency Anaemia Report 2023"

ПРИНЦИПЫ РАЗБОРА:
1. Каждое утверждение опирается на RCT, мета-анализы или клинические руководства (уровень A/B)
...
- Конкретные дозы добавок со ссылкой (например: "витамин D3 4000 МЕ/день — Holick MF, NEJM 2007")
